...
<head>
    ...
    <meta charset="utf-8" />
    <title>Réinitialiser le mot de passe | Velzon - Template Admin & Tableau de Bord</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Réinitialisez votre mot de passe avec Velzon</p>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Attendez, je me souviens de mon mot de passe... <a href="auth-signin-basic.html" class="fw-semibold text-primary text-decoration-underline"> Cliquez ici </a> </p>
                        </div>
